...
def preprocess_image(image: np.ndarray, pieces_found: bool) -> tuple:
    """
    ...
    centers, intersections, labels, sq_map = get_square_centers_in_original(merged_h, merged_v, M, image, warped, pieces_found=pieces_found, debug=True)  # Step 4
